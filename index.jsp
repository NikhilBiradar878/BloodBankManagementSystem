...
<body>
  ...
  {
  %>
  <center><font color="red" size="5"> Form Submited Successfully. You will notified within 24 hours.</font></center>
  <% 
  }
  %>
  <%
  ...
  %>
 <center>Enter Your Details to Request for Blood</center>
